...
public class AppCentrale {
    ...
    public AppCentrale(){
        ...
        try {
            ...
            this.conn= DriverManager.getConnection(url,"younesbenbouchta","K61LIHYGZ");
    ...
    public void inscrireEtudiantAuCours() {
        try {
            ...
            System.out.println("\nL'étudiant a été inscrit au cours avec succès.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void creerGroupe(){
        try{
            ...
            System.out.print("Entrez l'identifiant du projet auquel assigner le(s) groupe(s) : ");
            String idProjet = scanner.nextLine();
            System.out.print("Entrez le nombre de groupes a créer : ");
            ...
            ps.execute();
            System.out.println("Le(s) groupe(s) a/ont été créé(s) avec succès.");
        }catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void visualiserCompositionsDeGroupeDUnProjet(){
        try{
            ...
            while (resultSet.next()){
                ...
                System.out.println("Groupe validé ? : " + (resultSet.getString(5).equals("f") ? "non" : "oui"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public void validerGroupe() {
        try {
            ...
            System.out.println("\nLe groupe a été validé avec succès.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    public void validerTousLesGroupes(){
        try{
            ...
            ps.setString(1, idProjet);
            ps.execute();
            System.out.println("\nLes groupes ont été validés avec succès.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
